<div align="center">
  <img src="procurement-platform/client/public/procurex-ui/assets/logo.svg" alt="ProcureX logo" width="104">

  # ProcureX Introduction
...
For setup, environment variables, local ports, and demo credentials, see the [root README](README.md).
...
| `procurement-platform/client/public/procurex-ui/` | Static HTML/CSS/JavaScript prototype used as the visual, wording, and workflow reference for the production client. |
...
- Free local ports: `4000`, `5173`, `55432`, `6379`, `9200`, `9000`, and `9002`
...
| Command | Purpose |
| --- | --- |
| `npm run dev` | Start the Express backend and Vite React client together. |
| `npm run dev:server` | Start the Express backend in watch mode. |
...
|-- LICENSE
|-- NOTICE
|-- Introduction.md          # Product overview and implementation introduction
`-- README.md                # Local setup, environment, and run guide
```
...
- reference pages from `procurement-platform/client/public/procurex-ui/index.html?page=...`
...
| Document | Purpose |
| --- | --- |
| [`README.md`](README.md) | Local setup, environment, credentials, and run guide. |
...
| [`procurement-platform/client/public/procurex-ui/README.md`](procurement-platform/client/public/procurex-ui/README.md) | Static prototype route list and maintenance notes. |

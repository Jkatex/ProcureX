...
export const routes = [
  ...
  { path: '/awards-contracts/drafting', element: verifiedPage('contract-drafting', { adminRedirectTo: '/admin/search' }) },
  { path: '/awards-contracts/drafting/clauses', element: verifiedPage('contract-clauses', { adminRedirectTo: '/admin/search' }) },

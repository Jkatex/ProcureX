  ...
  <div class="main-layout procurement-layout awarding-contracts-page tender-planning-page">
    <aside class="sidebar evaluation-sidebar">
      ...
      <ul class="sidebar-nav">
        <li><a href="#" data-navigate="tender-planning" class="active">Dashboard</a></li>
        ...
        <li><a href="#planning-reports">Planning Reports</a></li>
    ...
    <main class="main-content procurement-content awarding-contracts-workspace">
      <section class="procurement-hero evaluation-hero-panel award-hero-panel tender-planning-hero planning-command-hero">
        <div>

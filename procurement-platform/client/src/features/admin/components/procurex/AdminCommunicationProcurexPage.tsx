/* Renders the admin Admin Communication ProcureX page UI while keeping page-specific presentation near its workflow data. */
...
function metadataFromComposeParams(params: URLSearchParams): Record<string, unknown> {
  ...
  const reviewDecision = params.get('reviewDecision');
  return {
    ...(mode ? { mode } : {}),

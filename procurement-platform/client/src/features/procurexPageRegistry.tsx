...
export const procurexPageRegistry = {
  ...
  'post-award': lazy(() => import('@/features/awardsContracts/components/procurex/PostAwardTrackingProcurexPage').then((module) => ({ default: module.PostAwardTrackingProcurexPage }))),

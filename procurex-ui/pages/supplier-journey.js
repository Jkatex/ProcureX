...
function renderSupplierJourney() {
    const stages = [
        ...
        ['Contracting', 'Final draft accepted', 'Review the draft contract, request changes, accept the final draft, then complete digital signing.', 'contract-negotiation', 'Pending'],
